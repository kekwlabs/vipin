...
import 'package:vipin/constants/colorsConst.dart';
import 'package:vipin/models/servers.dart';
                        ...
                        child: Center(
                          child: CircleAvatar(
                            backgroundImage: AssetImage(
                                'assets/country/${Provider.of<Vpns>(context).connectedVpn.countryCode.toLowerCase()}.png'),
                            radius: 40,
